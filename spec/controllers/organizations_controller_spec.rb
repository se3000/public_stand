  ...
  describe "#create" do
    context "when the organization is valid" do
      ...
      it "redirects to the new organization page" do
        ...
        expect(response).to redirect_to "http://#{Organization.last.vanity_string}.#{ENV['HOST_BASE']}:#{ENV['PORT']}/"
      end
    end
  ...
  describe "#update" do
    context "when the organization is valid" do
      ...
      it "redirects to the new organization page" do
        ...
        expect(response).to redirect_to "http://#{organization.vanity_string}.#{ENV['HOST_BASE']}:#{ENV['PORT']}/"
      end
    end
