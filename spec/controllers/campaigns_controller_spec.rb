  ...
  describe "#create" do
    context "when the campaign is valid" do
      ...
      it "creates a new instance of campaign" do
        ...
        expect(response).to redirect_to "http://#{organization.vanity_string}.#{ENV['HOST_BASE']}:#{ENV['PORT']}/#{Campaign.last.vanity_string}"
      end
    end
  ...
  describe "#update" do
    ...
    context "when the campaign is valid" do
      ...
      it "creates a new instance of campaign" do
        ...
        expect(response).to redirect_to "http://#{organization.vanity_string}.#{ENV['HOST_BASE']}:#{ENV['PORT']}/#{campaign.vanity_string}"
      end
    end
